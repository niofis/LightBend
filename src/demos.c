...
void Demo3()
{
	...
	escena.materials[i].id=i;
	escena.materials[i].ptr_textura=0;
	escena.materials[i].reflexion=0.7f;
	escena.materials[i].refraccion=0;
	escena.materials[i].specular=1.0f;
	escena.materials[i].textura=0;
	escena.materials[i].txt_height=0;
	...
	escena.materials[i].ptr_textura=0;
	escena.materials[i].reflexion=0;
	escena.materials[i].refraccion=GLASS_INDEX;//GLASS_INDEX;
	escena.materials[i].specular=1.0f;
	escena.materials[i].textura=0;
	escena.materials[i].txt_height=0;
	escena.materials[i].txt_width=0;
	...
	escena.materials[i].ptr_textura=0;
	escena.materials[i].reflexion=0;
	escena.materials[i].refraccion=AIR_INDEX;
	escena.materials[i].specular=1.0f;
	escena.materials[i].textura=0;
	escena.materials[i].txt_height=0;
	escena.materials[i].txt_width=0;
...
void Demo9()
{
	...
	for(i=0;i<escena.num_materials;i++)
	{
		...
		escena.materials[i].id=i;
		escena.materials[i].ptr_textura=0;
		escena.materials[i].reflexion=ms3d_material->shininess;
		escena.materials[i].refraccion=ms3d_material->transparency;
		escena.materials[i].specular=1.0f;
		escena.materials[i].textura=0;
		escena.materials[i].txt_height=0;
		escena.materials[i].txt_width=0;
