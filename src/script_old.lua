...
--[[
local o=prm.Sphere:new{radius=0.5, center=prm.Vector3:new{x=-1,y=0,z=0}, slices=10, resolution=20, group=g}
--o.bottom=1
tb.insert(scene.objects,o)
--addLevel(o,1)

local b=prm.Box:new{center=prm.Vector3:new{x=1,y=0,z=0},width=1,height=1,length=1,group=g}
tb.insert(scene.objects,b)
]]
...
--tb.insert(scene.models, "D:/Users/niofis/Personal/Raytracing/Models/sponza.3ds")
